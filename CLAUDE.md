...
Issues and specs are tracked in GitHub Issues on `Egge21M/npubcash-server`; external pull requests are not a triage surface. See `docs/agents/issue-tracker.md`.
